...
import br.edu.ifms.loja.fornecedores.bo.FornecedoresBO;
import br.edu.ifms.loja.fornecedores.bo.FornecedoresController;
import br.edu.ifms.loja.fornecedores.view.FornecedoresForm;
import br.edu.ifms.loja.fornecedores.view.FornecedoresView;
import br.edu.ifms.loja.produtos.bo.ProdutosBO;
import br.edu.ifms.loja.produtos.bo.ProdutosController;
...
public class JanelaInternaCadastros extends javax.swing.JInternalFrame {
    ...
    private void botaoFornecedoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoFornecedoresActionPerformed
        FornecedoresBO model = new FornecedoresBO();
        FornecedoresForm form = new FornecedoresForm();
        FornecedoresView view = new FornecedoresView(form);
        FornecedoresController controller = new FornecedoresController(model, view);
        view.setVisible(true);
    ...
    private void botaoProdutosActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ProdutosBO model = new ProdutosBO();
        ProdutosForm form = new ProdutosForm();
        ProdutosView view = new ProdutosView(form);        
        ProdutosController controller = new ProdutosController(model, view);    
        view.setVisible(true);
    } 
